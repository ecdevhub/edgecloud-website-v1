  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(135deg, #F4F6F8 0%, #EDF2F7 100%)",
        padding: 24,
      }}
    >
      <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <form onSubmit={submit}>
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <input
                ...
                placeholder="admin@edgecloudtech.co.ke"
                style={F}
        ...
        <p style={{ textAlign: "center", fontSize: 12, color: "#8B96A3", marginTop: 20 }}>
          EdgeCloud Technologies · Admin Panel
        </p>
      </div>
    </div>
  );
