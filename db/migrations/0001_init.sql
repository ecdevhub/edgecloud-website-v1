...
CREATE DATABASE IF NOT EXISTS `edgecloud_blog` CHARACTER
SET
...
-- Seed
INSERT IGNORE INTO `categories` (`name`, `slug`, `color`)
VALUES
  ('Compliance', 'compliance', '#00A2FF'),
  ('Engineering', 'engineering', '#00C9A7'),
  ('Cloud', 'cloud', '#7C3AED'),
  ('MarTech', 'martech', '#F59E0B'),
  ('Finance', 'finance', '#059669'),
  ('Product News', 'product-news', '#DC2626');
...
VALUES
  ...
  (
    'blog_description',
    'Practical guides for Kenya''s digital builders'
  ),
  ('posts_per_page', '9'),
  ('allow_comments', 'true'),
