    ...
    <section style={{ padding: "96px 0", background: "#FAFBFC", position: "relative" }}>
      ...
      <div
        style={{
          ...
          inset: 0,
          backgroundImage:
            "repeating-linear-gradient(45deg, transparent, transparent 32px, rgba(0,162,255,0.02) 32px, rgba(0,162,255,0.02) 33px)",
          pointerEvents: "none",
        }}
      />
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 15, color: "#4A5568", lineHeight: 1.65, margin: 0 }}>
                      {p.desc}
                    </p>
                  </div>
                </div>
