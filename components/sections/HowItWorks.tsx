...
const steps = [
  ...
  },
  {
    ...
    color: "#8B5CF6",
    details: ["24/7 infrastructure monitoring", "MarTech via ZuriMail", "Quarterly performance reviews"],
  },
];
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 72 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 12 }}>
            ...
            <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#00A2FF" }}>How It Works</span>
            <div style={{ width: 20, height: 2, background: "#00A2FF", borderRadius: 2 }} />
          </div>
        ...
        <div style={{ position: "relative" }}>
          {/* Connector line */}
          <div style={{
            position: "absolute", top: 56, left: "calc(50% - 120px)",
            width: "100%", maxWidth: 800,
            height: 1, background: "linear-gradient(90deg, #00A2FF, #00C9A7, #8B5CF6)",
            opacity: 0.25,
            display: "none",
          }} className="md:block" />
          ...
          <div style={{ display: "grid", gap: 32 }} className="grid-cols-1 md:grid-cols-3">
            {steps.map((step, i) => (
              ...
              onMouseLeave={(e) => {
                ...
                <h3 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: 20, color: "#0F1923", marginBottom: 14 }}>{step.title}</h3>
                <p style={{ fontSize: 15, color: "#4A5568", lineHeight: 1.7, marginBottom: 24 }}>{step.desc}</p>
                ...
                {i < steps.length - 1 && (
                  <div style={{
                    ...
                    color: step.color, fontSize: 20, opacity: 0.4, zIndex: 2,
                    display: "none",
