...
const articles = [
  {
    ...
    excerpt:
      "What the Data Protection Act 2019 actually means for your cloud setup - and how to build compliant from day one without slowing your product down.",
    readTime: "7 min read",
    date: "Feb 2025",
  },
  {
    ...
    excerpt:
      "Sandbox gotchas, callback URL patterns, and the reconciliation logic that nobody talks about - from engineers who've done it across dozens of projects.",
  ...
  },
  {
    ...
    excerpt:
      "Managed Kubernetes vs. simpler orchestration - a framework for making the right infrastructure decision at each stage of your East African startup.",
    readTime: "9 min read",
    date: "Dec 2024",
  },
];
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          <div>
            ...
            >
              Practical thinking for builders.
            </h2>
          </div>
          <Link
            href="/resources"
        ...
        <div style={{ display: "grid", gap: 20 }} className="grid-cols-1 md:grid-cols-3">
          {articles.map((a) => (
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "#8B96A3", lineHeight: 1.65, marginBottom: 20 }}>
                {a.excerpt}
              </p>
              <div
                style={{
