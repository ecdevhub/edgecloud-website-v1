        ...
        <div style={{ display: "grid", gap: 24 }} className="grid-cols-1 md:grid-cols-3">
          {products.map((p) => (
            ...
            >
              ...
              <p style={{ fontSize: 15, color: "#4A5568", lineHeight: 1.65, marginBottom: 24 }}>
                {p.tagline}
              </p>
              ...
              >
                {p.bullets.map((b) => (
                  <li key={b} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                    <CheckCircle2
                      size={15}
                      style={{ color: p.color, marginTop: 2, flexShrink: 0 }}
                    />
              ...
              <div style={{ marginTop: "auto" }}>
                ...
                >
                  {p.comingSoon ? "Stay tuned" : "View product"}{" "}
                  {!p.comingSoon && <ArrowRight size={14} />}
                </Link>
              </div>
            </div>
          ))}
